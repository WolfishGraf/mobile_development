...
import com.mirea.strakhoval.mireaproject.databinding.ActiveSecondBinding;

public class Second extends AppCompatActivity {
    private ActiveSecondBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActiveSecondBinding.inflate(getLayoutInflater());
