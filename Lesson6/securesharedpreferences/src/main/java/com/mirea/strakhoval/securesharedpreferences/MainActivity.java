package com.mirea.strakhoval.securesharedpreferences;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            secureSharedPreferences.edit().putString("secure", "Crown  and Sword").apply();
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.ic_crown);
